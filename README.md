...
- **React 18 + Vite** — SPA, two routes (`/`, `/guide`)
...
Project-card imagery generated with Higgsfield (nano-banana), hosted on Higgsfield's CDN. Prompts documented on `/guide`.
...
Full making-of: the `/guide` route.
